    ...
    <div class="post">
        ...
        <div class="texto">
            <div class="contenido">
                ...
                <h3 class="title">Subir galería de imagenes a noticia</h3>

                @include('layouts.fijos.messages-flash-box')

                <p>Se subirá una o más imágenes a noticia que tiene por título de portada &quot;<span class="text-bold">{{ $noticia->titulo_noticia }}</span>&quot;.</p>
                <p>Si esta noticia ya cuenta con una una o más imágenes, estas se sumarán al listado.</p><br /><hr /><br />

                <form
                    action="{{ route('intranet.noticias.postgaleria', ['noticia' => $noticia->id_noticia]) }}"
                    class="form opensans"
                    method="POST"
                    autocomplete="off"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="custom-file col-md-10">
                                ...
                                @if ($errors->has('inputFile'))
                                    <span class="invalid-feedback text-bold mb-3">{{ $errors->first('inputFile') }}</span>
                                @endif
                            </div>

                            <small class="form-text text-muted pt-{{ $errors->has('inputFile') ? "5" : "4" }} offset-md-2">
                                <ul>
