    ...
    <div class="post">
        ...
        <div class="texto">
            <div class="contenido">
                ...
                <p>Este es el Órgano colegiado que dirige la Institución, integrado por 6 miembros Ad Honorem, conforme a sus Estatutos consignados en el Decreto con Fuerza de Ley 1-18632, publicación en el año 1988, que señala en su Titulo II:</p>

                <p class="italic">“Del Consejo Directivo
                    ...
                    d) Un representante de las Municipalidades de la Segunda Región de Antofagasta, que hayan celebrado convenios de asistencia judicial con la Corporación, y <br />e) Dos abogados de libre ejercicio de la profesión, designados por el Ministerio de Justicia a través de su División Judicial y que tengan su domicilio en la jurisdicción de la Corporación.”</p>
                ...
                <div class="table-responsive">
                    <table class="table table-stripped table-hover table-bordered">
                        ...
                        <tbody>
                            <tr>
                                <td><strong>Fernando Mauricio Canales Hertrampf</strong> <small>(Abogado)</small></td>
                                <td>Presidente</td>
                                <td>SEREMI de Justicia y Derechos Humanos, Región de Tarapacá</td>
                                <td>18-04-2018</td>
                                <td>Decreto Nº388 Ministerio de Justicia y Derechos Humanos</td>
                                <td>Término del cargo</td>
                            </tr>

                            <tr>
                                <td><strong>Paula García Barría</strong> <small>(Abogada)</small></td>
                ...
                <div class="table-responsive">
                    <table class="table table-stripped table-hover table-bordered">
                        ...
                        <tbody>
                        <tr>
                            <td><strong>Raúl Gil González</strong></td>
                            <td>Secretario</td>
                            <td>SEREMI de Justicia y Derechos Humanos, Región de Arica y Parinacota</td>
                            <td>29-03-2018</td>
                            <td>Decreto Nº337 Ministerio de Justicia y Derechos Humanos</td>
                            <td>Término del cargo</td>
                        </tr>
                        </tbody>
                    </table>
