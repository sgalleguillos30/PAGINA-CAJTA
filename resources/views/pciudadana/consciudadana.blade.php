    ...
    <div class="post">
        ...
        <div class="texto">
            <div class="contenido">
                ...
                <ul>
                    <li><a target="_blank"  class="opensans" href="{{ asset('assets/docs/partciudadana/consciudadana/2023/CONSULTA-CIUDADANA-2023.pdf') }}">Informe Consulta Ciudadana 2023.</a></li>
                    <li><a target="_blank"  class="opensans" href="{{ asset('assets/docs/partciudadana/consciudadana/2022/CONSULTA-CIUDADANA-2022.pdf') }}">Informe Consulta Ciudadana 2022.</a></li>
                    <li><a target="_blank"  class="opensans" href="{{ asset('assets/docs/partciudadana/consciudadana/2021/CONSULTA-CIUDADANA-2021.pdf') }}">Informe Consulta Ciudadana 2021.</a></li>
                    <li><a target="_blank"  class="opensans" href="{{ asset('assets/docs/partciudadana/consciudadana/2020/CONSULTA-CIUDADANA-2020.pdf') }}">Informe Consulta Ciudadana 2020.</a></li>
